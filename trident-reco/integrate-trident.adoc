...
Astra Trident 使用  `azure-netapp-files` 驅動程式來管理 link:https://azure.microsoft.com/en-us/products/netapp/["Azure NetApp Files"^] 服務。
...
如需 Cloud Volumes Service on Google Cloud 服務類型和服務層級的詳細資訊、請參閱 link:../trident-use/gcp.html["瞭解Astra Trident對CVS for GCP的支援"]。
