...
使用 [`tridentctl` 公用程式，您可以執行  `get` 命令來取得從屬磁碟區。如需詳細資訊，請參閱 link:../trident-managing-k8s/tridentctl.html[`tridentctl` 命令和選項]。
...
* 觀看 link:https://www.netapp.com/video/solutions-and-products/["NetAppTV"^] 上的示範影片。
