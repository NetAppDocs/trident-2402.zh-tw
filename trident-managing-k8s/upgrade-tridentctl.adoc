...
.開始之前
在使用 `tridentctl`進行升級之前，請先檢查link:upgrade-trident.html#step-3-select-an-upgrade-method["選擇升級方法"]。
...
----
. 重新安裝 Astra Trident。請參閱 link:../trident-install/kubernetes-deploy-tridentctl.html["使用tridentctl安裝Astra Trident"]。
